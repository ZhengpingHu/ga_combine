...
# Modified for Multi-Run (Seeds 101-105)
...
def run_ga(args):
    ...
    # MODIFIED: Append seed to folder name for clarity in multi-run batch
...
if __name__ == "__main__":
    ...
    for run_idx, seed in enumerate(seeds_to_run):
        ...
        # Override seeds for this run
        args.global_seed = seed
        # Also sync the pool_rng_seed so the seed portfolio shuffling is unique per run
