...
# Simulation parameters (MountainCar PPO ran for 3M steps, recorded every 10K)
MAX_STEPS = 3_000_000 
RESOLUTION = 10000    

# ==========================================
# 2. Environment Specific Axis Settings (MountainCar)
# ==========================================
# MountainCar standard rewards range from -200 (timeout) to approx -85 (optimal)
Y_MIN = -210
Y_MAX = -70
TARGET_REWARD = -80
TARGET_LABEL = f"Maximum Physics Reward Approx ({TARGET_REWARD})"
...
TASKS = {
    "mc_clean": {
        "folder_pattern": "ppo_3m_clean_mc_results_seed_*",
        "color": "#2C3E50", # Dark Blue
        "title": "(a) PPO 3M Learning Curve (MountainCar Clean)"
    },
    "mc_noisy": {
        "folder_pattern": "ppo_3m_noisy_mc_results_seed_*",
        "color": "#E74C3C", # Red
        "title": "(b) PPO 3M Learning Curve (MountainCar Noisy)"
    }
}
...
def plot_single_task(task_key, config):
    ...
    # Position the text slightly above the line (+2 is up since Y is negative)
    ax.text(MAX_STEPS * 0.02, TARGET_REWARD + 2, TARGET_LABEL, color='gray', fontsize=8, alpha=0.8)
...
def main():
    print("=========================================")
    print(" Generating MC Independent Learning Curves")
    print("=========================================")
    ...
    print("=========================================")
    print(" All MC plots have been generated!       ")
