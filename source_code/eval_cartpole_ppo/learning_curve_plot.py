...
# Simulation parameters (CartPole PPO ran for 3M steps, recorded every 10K)
MAX_STEPS = 3_000_000 
RESOLUTION = 10000    

# ==========================================
# 2. Environment Specific Axis Settings (CartPole)
# ==========================================
Y_MIN = -10
Y_MAX = 520
TARGET_REWARD = 500
...
def plot_single_task(task_key, config):
    ...
    ax.text(MAX_STEPS * 0.02, TARGET_REWARD + 5, TARGET_LABEL, color='gray', fontsize=8, alpha=0.8)
...
def main():
    print("=========================================")
    print(" Generating Independent Learning Curves  ")
    print("=========================================")
