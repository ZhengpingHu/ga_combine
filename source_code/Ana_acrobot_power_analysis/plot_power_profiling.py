...
# ==========================================
DATA_FILES = {
    "PPO (No Noise)": "ppo_acrobot_clean_power_log.csv",
    "PPO (Noisy)": "ppo_acrobot_noisy_power_log.csv",
    "GA+YOLO (No Noise)": "acrobot_ga_clean_power_log.csv",
    "GA+YOLO (Noisy)": "acrobot_ga_noisy_power_log.csv"
}
