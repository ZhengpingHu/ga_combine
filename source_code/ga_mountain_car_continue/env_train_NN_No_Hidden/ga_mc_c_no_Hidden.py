#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# MountainCar GA Client: Energy Shaping (Hidden) + Raw Plotting + Direct Env Input + Continuous Action Fix
...
def run_ga(args):
    ...
    print(f"MountainCar GA (Direct Env) started. Logs: {run_dir}")
    ...
    final_jobs = [(i, j, pop[i], seed, args.max_steps) 
