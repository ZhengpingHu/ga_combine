...
def main():
    ...
    jobs = []
    print("Loading models and preparing YOLO evaluation tasks...")
    ...
    for agent_seed, path in MODEL_PATHS.items():
        ...
        models_found += 1
        for s in test_seeds:
            jobs.append((agent_seed, weights, s, args.rpc_host, args.rpc_port, args.authkey))
    ...
    csv_path = os.path.join(args.outdir, "mc_yolo_eval_seed106.csv")
