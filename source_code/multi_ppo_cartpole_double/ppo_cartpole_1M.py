...
if __name__ == "__main__":
    ...
    print("=== Starting E2E PPO Vision Baseline (3M PARAMS, CLEAN ENV) Tests ===")
    ...
    for idx, run_seed in enumerate(test_seeds):
        ...
        # 【修改点 1】: 输出文件夹增加 "3m_clean" 标记，保护你原来的 1.6M 干净数据
        seed_dir = f"ppo_3m_clean_results_seed_{run_seed}"
        ...
        # Initialize PPO with custom 3M architecture
        ...
        print(f"[*] PPO 3M Model Instantiated (CLEAN ENVIRONMENT)!")
    ...
    print("\n" + "="*50)
    print("=== FINAL CONVERGENCE SUMMARY (3M PARAMS, CLEAN ENV) ACROSS 5 SEEDS ===")
